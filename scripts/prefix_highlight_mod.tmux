...
# z prefix highlight
# fork : https://github.com/tmux-plugins/tmux-prefix-highlight
# ============================================================
...
default_fg='blue'
default_bg='default'
default_copy_attr='fg=yellow,bg=default'
default_sync_attr='fg=green,bg=default'
default_empty_attr='fg=colour244,bg=default'
...
main() {
    local -r \
        ...
        show_copy_mode=$(tmux_option "$show_copy_config" "on") \
        show_sync_mode=$(tmux_option "$show_sync_config" "on") \
        ...
        empty_has_affixes=$(tmux_option "$empty_has_affixes" "on")
    ...
    tmux set-option -gq "@prefix_highlight" "#{prefix_highlight}"
    local -r prefix_value="$(tmux_option "@prefix_highlight")"
    tmux set-option -gq "@prefix_highlight" "${prefix_value/$place_holder/$highlight}"
